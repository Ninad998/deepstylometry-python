...
def getResults(glove = '../glove/', dimensions = 200, dropout = 0.5, chunk_size = 1000, batch_size = 10, nb_epoch = 30):
    ...
    # (testX, textY) = md.loadDocData(doc_id, chunk_size = chunk_size)
...
def getTestResults(doc_id = 0, glove = '../glove/', dimensions = 200, chunk_size = 1000, batch_size = 10):
    ...
    (testX, textY) = md.loadDocData(doc_id, genderList, chunk_size = chunk_size)
    ...
    test_acc = md.predictModel(model, testX, textY, batch_size = batch_size)
