...
def getResults(authorList = None, doc_id = None, chunk_size = 1000, nb_epoch = 30, level = 'word', glove = '../glove/'):
    if (authorList is None) or (doc_id is None) or (doc_id == 0):
        ...
        # embeddings_index = md.readVectorData(embedfile, GLOVE_DIR='/var/tmp/')
